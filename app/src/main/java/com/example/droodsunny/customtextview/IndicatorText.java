...
public class IndicatorText extends View {
    ...
    public IndicatorText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < attrCount; i++) {
            ...
            switch (attr) {
                case R.styleable.SideText_textSize:
                    textSize = attributes.getDimensionPixelSize(R.styleable.SideText_textSize, 40);
                    break;
                case R.styleable.SideText_textSpace:
                    textSpace = attributes.getDimensionPixelSize(R.styleable.SideText_textSpace, 10);
                    break;
                case R.styleable.SideText_tWidth:
                    dWidth = attributes.getDimensionPixelSize(R.styleable.SideText_tWidth, 60);
                    break;
                case R.styleable.SideText_selectedColor:
                    selectColor = attributes.getColor(R.styleable.SideText_selectedColor, green);
                    break;
                case R.styleable.SideText_backColor:
                    touchBgColor=attributes.getColor(R.styleable.SideText_backColor,grey);
                    break;
                case R.styleable.SideText_textTouchedColor:
                    touchTextColor=attributes.getColor(R.styleable.SideText_textTouchedColor,white);
                    break;
                case R.styleable.SideText_textDefaultColor:
                    defaultTextColor=attributes.getColor(R.styleable.SideText_textDefaultColor,grey);
                    break;
            }
        }
        attributes.recycle();
